                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div id="datatable" class="mb-5">
                            <h4>Datatable</h4>
                            <p>DataTables is a plug-in for the jQuery Javascript library. It is a highly flexible tool,
                                built upon the foundations of progressive enhancement, that adds all of these advanced
                                features to any HTML table. Please read the <a href="https://datatables.net/"
                        ...
                        <div id="bootstrapTable" class="mb-5">
                            <h4>Basic Table</h4>
                            <p>Bootstrap table is an extended table to the integration with some of the most widely used CSS
                                frameworks. (Supports Bootstrap, Semantic UI, Bulma, Material Design, Foundation). Please
                                read the <a href="https://bootstrap-table.com/" target="_blank">official documentation</a>
