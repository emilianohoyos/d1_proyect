                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange"
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-up"></i> 16% increase
                                <br>compare to last week
                            </div>
                            <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View
                                    report <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a></div>
                        </div>
                        <!-- BEGIN card-body -->
                    </div>
                    <!-- END card -->
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal"
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-up"></i> 33% increase
                                <br>compare to last week
                            </div>
                            <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View
                                    report <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a></div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink"
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-down"></i> 5% decrease
                                <br>compare to last week
                            </div>
                            <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View
                                    report <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a></div>
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo"
                        ...
                        <!-- BEGIN card-img-overlay -->
                        <div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="/assets/img/icon/browser.svg" alt="" class="ms-auto d-block mb-n3"
                                style="max-height: 105px">
                        </div>
                        <!-- end card-img-overlay -->
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white text-opacity-80 mb-4"><i class="fa fa-caret-up"></i> 20% increase
                                <br>compare to last week
                            </div>
                            <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View
                                    report <i class="fa fa-chevron-right ms-2 text-white text-opacity-50"></i></a></div>
